...
public class IfrEstado extends javax.swing.JInternalFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        estad.setId(Integer.parseInt(txtCodigo) );
        estad.setDescricao(txtDescricao.getText());
        estad.setUf(txtUf.getText());
       // estad.setSituacao(txtSituacao.getText().charAt(0));
        ...
        if (codigo == 0) {
            // salvar = inserir
            retorno = estadoDAO.salvar(estad);
        } else {
            // atualizar = update
            retorno = estadoDAO.atualizar(estad);
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (estad == null) {
            ...
            txtUf.setText(String.valueOf(estad.getUf()));
